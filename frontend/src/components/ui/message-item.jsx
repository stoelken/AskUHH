...
export function MessageItem({ role, content, sources, avgProbability = null, streaming = false, followups = [], isLatest = false, onFollowupClick }) {
  ...
  return (
    ...
    >
      ...
      {!isUser && !streaming && isLatest && followups.length > 0 && (
